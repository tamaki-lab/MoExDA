...
class MyLabeledVideoDataset(torch.utils.data.IterableDataset):
    """
    ...
    def __next__(self) -> dict:
        ...
        for i_try in range(self._MAX_CONSECUTIVE_FAILURES):
            ...
            # 動画のフレームを取得し、フレーム数を16に揃える
            frames = self._loaded_clip["video"]
            frames = uniform_temporal_subsample(frames, self._frames_per_clip)
